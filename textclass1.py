...
st.header('Принцип "мешок слов" ',anchor='bagofwords')
...
st.image(pictures_path+'authorsfiles7.jpg',caption='')
st.write('Во время обучения на вход нейронной сети подаются числовые матрицы. На выход подаются единичные векторы для каждого класса. ')
